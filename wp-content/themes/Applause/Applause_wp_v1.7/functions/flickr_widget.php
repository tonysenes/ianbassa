...
class flickrwidget extends WP_Widget {
    ...
    function flickrwidget() {
        ...
        parent::WP_Widget(false, 'Metrothemes flickr', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo $this->get_field_id('flickr_title'); ?>"><?php _e('Title:', 'lucas'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('flickr_userid'); ?>"><?php _e('Flickr user ID:', 'lucas'); ?></label>
            <br>
        ...
        <p><label for="<?php echo $this->get_field_id('flickr_num'); ?>"><?php _e('How many pictures display:', 'lucas'); ?></label>
